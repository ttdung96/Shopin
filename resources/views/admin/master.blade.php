								...
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   <div class="user_img"><img src="public/admin/images/in11.jpg" alt=""></div>
											...
											<li class="odd"><a href="#">
												<div class="user_img"><img src="public/admin/images/in10.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor </p>
												<p><span>1 hour ago</span></p>
												</div>
											...
											<li><a href="#">
											   <div class="user_img"><img src="public/admin/images/in9.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
												<div class="user_img"><img src="public/admin/images/in8.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li class="odd"><a href="#">
												<div class="user_img"><img src="public/admin/images/in6.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li><a href="#">
												<div class="user_img"><img src="public/admin/images/in7.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="public/admin/images/in4.jpg" alt=""> </span> 
												<div class="user-name">
													<p>Malorum</p>
